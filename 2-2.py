...
def parse_sets(line: str) -> list[Set]:
    # Example input:
    # "1 blue, 5 red; 3 blue, 5 green, 13 red; 6 red, 1 blue, 4 green; 16 red, 12 green"
    result = []
    set_strs = line.split(";")
...
def parse_game(line: str) -> Game:
    # Example input:
    # "Game 1: 1 blue, 5 red; 3 blue, 5 green, 13 red; 6 red, 1 blue, 4 green; 16 red, 12 green"
...
for line in fileinput.input():
    ...
    smallest_bag = game.smallest_bag()
    sum += smallest_bag.power()
